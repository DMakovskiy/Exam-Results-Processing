...
def find_by_key(iterable, key, value):
    # находит в списке словарей словарь с указанным ключом и значением и возвращает индекс этого словаря и сам словарь.
    # если такого словаря в списке нет, возвращает кортеж (-1, -1)
